...
describe('Games', () => {
	...
	describe('/GET games/:id', () => {
		it('it should get a specific game', (done) => {
			...
			expectedGame.save();
			chai.request(app)
				.get('/games/' + expectedGame._id)
				.end((err, res) => {
					res.should.have.status(200);
					res.body.should.be.a('object');
					res.body.sport.should.be.eql(expectedGame.sport);
					res.body.result.should.be.eql(expectedGame.result);
					done();
				});
		})
	});
	...
	describe('/DELETE games/:id', () => {
		it('it should delete a specific game', (done) => {
			...
			expectedGame.save();
			chai.request(app)
				.delete('/games/' + expectedGame.id)
				.end((err, res) => {
					res.should.have.status(200);
					res.body.message.should.eql("Game successfully deleted!");
